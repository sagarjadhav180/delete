...
//	private static WebElement userprofile_link;
	...
	@FindBy(xpath = "//div[starts-with(@class,'alert ') and @aria-hidden='false']/div")
	private static WebElement resetPasswordSuccessMessage;
	String expected_resetPasswordSuccessMessage = "Check your e-mail for your temporary password";
...
//        this.extent=extent;
	...
	public void UIVerification_LoginPage() {
		...
		softassert.assertTrue(rememberMe_Checkbox.isDisplayed(),
				"remember me checkbox is not present or locator has changed");

		// Verification of Forgot password link and its enable
		logger.log(LogStatus.INFO, "Verifying presence of Forgot password link..");
		softassert.assertTrue(forgotPassword_link.isDisplayed(),
				"Forgot password link checkbox is not present or locator has changed");
	...
	public void UIVerification_ResetPasswordPage() throws InterruptedException {
		...
		softassert.assertTrue(forgot_password_window_title.isDisplayed(),
				"forgot_password_window_title is not present or locator changed");
	...
	public void nextButtonClickOnResetPasswordPageWithBlankMailID() {
		...
		softassert.assertTrue(resetPasswordFailureMessage.isDisplayed(),
				"failure message is not displayed or locator changed");
		Util.click(backButton);
		softassert.assertAll();
	}
	...
	public void resetPasswordFeature() throws IOException {
		...
		if(resetPasswordSuccessMessage.getText().equals(expected_resetPasswordSuccessMessage)) {
